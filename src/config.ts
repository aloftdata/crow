...
export default {
  ...
  availableRadars: [
   ...
   { odimCode: "fikan", text: "Kankaanpää", latitude: 61.9069, longitude: 29.7977, timezone: "Europe/Helsinki", endpoint: aloftBaltradUrl, heights: availableHeights, vptsFileFormat: "CSV" },
