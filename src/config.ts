  ...
  availableRadars: [
    ...
    },
    {
      ...
      options: [
        ...
        { odimCode: "dkrom", text: "Römö", latitude: 55.1731, longitude: 8.5520, timezone: "Europe/Copenhagen", endpoint: aloftBaltradUrl, heights: availableHeights, vptsFileFormat: "CSV" },
        { odimCode: "dksam", text: "Samsø", latitude: 55.8119, longitude: 10.5853, timezone: "Europe/Copenhagen", endpoint: aloftBaltradUrl, heights: availableHeights, vptsFileFormat: "CSV" },
        ...
        { odimCode: "dkvir", text: "Virring", latitude: 56.0240, longitude: 10.0246, timezone: "Europe/Copenhagen", endpoint: aloftBaltradUrl, heights: availableHeights, vptsFileFormat: "CSV" }
      ]
    },
    {
      label: "Estonia",
      options: [
        { odimCode: "eehar", text: "Harku", latitude: 59.3971, longitude: 24.6021, timezone: "Europe/Tallinn", endpoint: aloftBaltradUrl, heights: availableHeights, vptsFileFormat: "CSV" },
    ...
    },
    {
      ...
      options: [
        ...
        { odimCode: "fikan", text: "Kankaanpää", latitude: 61.8108, longitude: 22.5020, timezone: "Europe/Helsinki", endpoint: aloftBaltradUrl, heights: availableHeights, vptsFileFormat: "CSV" },
        ...
        { odimCode: "fivan", text: "Vantaa", latitude: 60.2706, longitude: 24.8690, timezone: "Europe/Helsinki", endpoint: aloftBaltradUrl, heights: availableHeights, vptsFileFormat: "CSV" },
    ...
    },
    {
      label: "France",
      options: [
        { odimCode: "frabb", text: "Abbeville", latitude: 50.1360, longitude: 1.8347, timezone: "Europe/Paris", endpoint: aloftBaltradUrl, heights: availableHeights, vptsFileFormat: "CSV" },
        ...
        { odimCode: "frbol", text: "Bollène", latitude: 44.3230, longitude: 4.7621, timezone: "Europe/Paris", endpoint: aloftBaltradUrl, heights: availableHeights, vptsFileFormat: "CSV" },
        ...
        { odimCode: "frmau", text: "Mont Maurel", latitude: 44.01280, longitude: 6.5292, timezone: "Europe/Paris", endpoint: aloftBaltradUrl, heights: availableHeights, vptsFileFormat: "CSV" },
        ...
        { odimCode: "frmtc", text: "Montancy", latitude: 47.3686, longitude: 7.0190, timezone: "Europe/Paris", endpoint: aloftBaltradUrl, heights: availableHeights, vptsFileFormat: "CSV" },
        ...
        { odimCode: "fropo", text: "Opoul", latitude: 42.9184, longitude: 2.8650, timezone: "Europe/Paris", endpoint: aloftBaltradUrl, heights: availableHeights, vptsFileFormat: "CSV" },
    ...
    },
    {
      label: "Germany",
      options: [
        { odimCode: "deasb", text: "Isle of Borkum", latitude: 53.5640, longitude: 6.7482, timezone: "Europe/Berlin", endpoint: aloftBaltradUrl, heights: availableHeights, vptsFileFormat: "CSV" },
        ...
        { odimCode: "defld", text: "Flechtdorf", latitude: 51.3119, longitude: 8.8020, timezone: "Europe/Berlin", endpoint: aloftBaltradUrl, heights: availableHeights, vptsFileFormat: "CSV" },
        ...
        { odimCode: "dehnr", text: "Hannover", latitude: 52.4600, longitude: 9.6945, timezone: "Europe/Berlin", endpoint: aloftBaltradUrl, heights: availableHeights, vptsFileFormat: "CSV" },
    ...
    },
    {
      ...
      options: [
        ...
        { odimCode: "nlhrw", text: "Herwijnen", latitude: 51.8371, longitude: 5.1380, timezone: "Europe/Amsterdam", endpoint: aloftBaltradUrl, heights: availableHeights, vptsFileFormat: "CSV" }
      ]
    },
    {
      label: "Norway",
      options: [
        ...
        { odimCode: "nobml", text: "Boemlo", latitude: 59.8540, longitude: 5.0900, timezone: "Europe/Oslo", endpoint: aloftBaltradUrl, heights: availableHeights, vptsFileFormat: "CSV" },
        { odimCode: "nohas", text: "Hasvik", latitude: 70.6052, longitude: 22.4430, timezone: "Europe/Oslo", endpoint: aloftBaltradUrl, heights: availableHeights, vptsFileFormat: "CSV" },
        ...
        { odimCode: "norsg", text: "Rassegalvarri", latitude: 69.2186, longitude: 23.4397, timezone: "Europe/Oslo", endpoint: aloftBaltradUrl, heights: availableHeights, vptsFileFormat: "CSV" },
    ...
    },
    {
      label: "Poland",
      options: [
        { odimCode: "plbrz", text: "Brzuchania", latitude: 50.3942, longitude: 20.0832, timezone: "Europe/Warsaw", endpoint: aloftBaltradUrl, heights: availableHeights, vptsFileFormat: "CSV" },
        ...
        { odimCode: "plpas", text: "Pastewnik", latitude: 50.8925, longitude: 16.0395, timezone: "Europe/Warsaw", endpoint: aloftBaltradUrl, heights: availableHeights, vptsFileFormat: "CSV" },
    ...
    },
    {
      label: "Slovenia",
      options: [
        { odimCode: "silis", text: "Lisca", latitude: 46.0680, longitude: 15.2850, timezone: "Europe/Ljubljana", endpoint: aloftBaltradUrl, heights: availableHeights, vptsFileFormat: "CSV" },
        { odimCode: "sipas", text: "Pasja ravan", latitude: 46.0980, longitude: 14.2283, timezone: "Europe/Ljubljana", endpoint: aloftBaltradUrl, heights: availableHeights, vptsFileFormat: "CSV" }
      ]
    },
    {
      label: "Spain",
    ...
    },
    {
      ...
      options: [
        ...
        { odimCode: "seatv", text: "Åtvidaberg (Vilebo)", latitude: 58.1059, longitude: 15.9365, timezone: "Europe/Stockholm", endpoint: aloftBaltradUrl, heights: availableHeights, vptsFileFormat: "CSV" },
        { odimCode: "sebaa", text: "Bålsta", latitude: 59.6110, longitude: 17.5833, timezone: "Europe/Stockholm", endpoint: aloftBaltradUrl, heights: availableHeights, vptsFileFormat: "CSV" },
        ...
        { odimCode: "sella", text: "Luleå (Rosvik)", latitude: 65.4309, longitude: 21.8650, timezone: "Europe/Stockholm", endpoint: aloftBaltradUrl, heights: availableHeights, vptsFileFormat: "CSV" },
        ...
        { odimCode: "sevax", text: "Vara", latitude: 58.2556, longitude: 12.8260, timezone: "Europe/Stockholm", endpoint: aloftBaltradUrl, heights: availableHeights, vptsFileFormat: "CSV" },
    ...
    },
    {
      label: "Switzerland",
      options: [
        { odimCode: "chalb", text: "Albis", latitude: 47.2843, longitude: 8.5120, timezone: "Europe/Zurich", endpoint: aloftBaltradUrl, heights: availableHeights, vptsFileFormat: "CSV" },
        ...
        { odimCode: "chwei", text: "Weissfluhgiptel", latitude: 46.8350, longitude: 9.7945, timezone: "Europe/Zurich", endpoint: aloftBaltradUrl, heights: availableHeights, vptsFileFormat: "CSV"}
      ]
    }
